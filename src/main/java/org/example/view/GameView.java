...
public class GameView {
     ...
     * @param score A score Label ahova a scort írjuk
   ...
   public void setTimer(int timer1) {
    ...
    /**
     * Beállítja a pontot amennyit eddig eszerzet a játékos
     * @param score1 pont
     */
    ...
    /**
     * Berajzolja az összes aknaát amennyitben vagy rákatintott egyre vagy megnyerte a játékot.
     * @param i sorszám
     * @param j oszlopszám
     */
    ...
    /**
     * Rekurzívan hívódik meg h felfordítsa az összes olyan mezőt amely mellett nincs akna.
